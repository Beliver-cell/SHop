    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border border-gray-300 px-6 py-6 text-sm text-gray-500">
          <p>
            This product is crafted from premium materials and designed for
            comfort and durability. Each item is quality-checked and packaged
            with care to ensure it arrives in perfect condition.
          </p>
          <p>
            If you have any questions about sizing, materials, or care
            instructions, our customer support team is ready to assist. Easy
            returns and exchanges available within 7 days.
          </p>
        </div>
      </div>
